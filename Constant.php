...
class Constant{
    ...
    const REGEX_EMAIL = "/^[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)*\@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)*\.[a-zA-Z]{2,4}$/";
    ...
    const ERROR_CODE_THREAD_ANSWER = 14;
    ...
    const ERROR_CODE_FACEBOOK_FORMAT = 57;
    const ERROR_CODE_CREATE_THREAD_LIMIT = 77;
}
